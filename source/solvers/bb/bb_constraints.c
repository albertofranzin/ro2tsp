...
void bb_constraints_a(int w, int v, int u, double cost_wv, double cost_wu, bb_status* status, bb_backup* backup, bb_backup* update) {
  ...
  bb_backup_save_edge(backup, w, v, graph_get_edge_cost(G_curr, w, v));

  graph_set_edge_cost(G_curr, w, v, cost_wv);

  if (update != NULL) {
    bb_backup_save_edge(update, w, v, cost_wv);
  }
  ...
  if (u > 0) {
    ...
    bb_backup_save_edge(backup, w, u, graph_get_edge_cost(G_curr, w, u));

    graph_set_edge_cost(G_curr, w, u, cost_wu);

    if (update != NULL) {
      bb_backup_save_edge(update, w, u, cost_wu);
    }
...
void bb_constraints_ap_simple(int w, int v, int u, double cost_wv, double cost_wu, bb_status* status, bb_backup* backup, bb_backup* update) {
  ...
  bb_constraints_a(w, v, u, cost_wv, cost_wu, status, backup, update);
  ...
  if ((*status).num_forced_edges.array[w-1] >= 2 && (*status).num_forbidden_edges.array[w-1] < n-3) {
	...
	if (c > SMALL && c < BIG) {
	  ...
	  bb_constraints_a(w, i, 0, BIG, 0.0, status, backup, update);
	...
	if (c > SMALL && c < BIG) {
	  ...
	  bb_constraints_a(w, i, 0, SMALL, 0.0, status, backup, update);
  ...
  if ((*status).num_forced_edges.array[v-1] >= 2 && (*status).num_forbidden_edges.array[v-1] < n-3) {
	...
	if (c > SMALL && c < BIG) {
	  ...
	  bb_constraints_a(v, i, 0, BIG, 0.0, status, backup, update);
	...
	if (c > SMALL && c < BIG) {
	  ...
	  bb_constraints_a(v, i, 0, SMALL, 0.0, status, backup, update);
  ...
  if (u > 0) {
	...
	if (i != u) {
	  ...
	  if (c > SMALL && c < BIG) {
	    ...
	    bb_constraints_a(u, i, 0, BIG, 0.0, status, backup, update);
	...
	if (i != u) {
	  ...
	  if (c > SMALL && c < BIG) {
	    ...
	    bb_constraints_a(u, i, 0, SMALL, 0.0, status, backup, update);
...
void bb_constraints_ap_recursive(int w, int v, int u, double cost_wv, double cost_wu, bb_status* status, bb_backup* backup, bb_backup* update) {
  ...
  if ((*status).num_forced_edges.array[w-1] == 2 && (*status).num_forbidden_edges.array[w-1] < n-3) {
	...
	if (c > SMALL && c < BIG) {
	  ...
	  bb_constraints_ap_recursive(w, i, 0, BIG, 0.0, status, backup, update);
	...
	if (c > SMALL && c < BIG) {
	  ...
	  bb_constraints_ap_recursive(w, i, 0, SMALL, 0.0, status, backup, update);
  ...
  if ((*status).num_forced_edges.array[v-1] == 2 && (*status).num_forbidden_edges.array[v-1] < n-3) {
	...
	if (c > SMALL && c < BIG) {
	  ...
	  bb_constraints_ap_recursive(v, i, 0, BIG, 0.0, status, backup, update);
	...
	if (c > SMALL && c < BIG) {
	  ...
	  bb_constraints_ap_recursive(v, i, 0, SMALL, 0.0, status, backup, update);
  ...
  if (u > 0) {
	...
	if (i != u) {
	  ...
	  if (c > SMALL && c < BIG) {
	    ...
	    bb_constraints_ap_recursive(u, i, 0, BIG, 0.0, status, backup, update);
	...
	if (i != u) {
	  ...
	  if (c > SMALL && c < BIG) {
	    ...
	    bb_constraints_ap_recursive(u, i, 0, SMALL, 0.0, status, backup, update);
	...
	for (i = 1; i <= n; i++) {
	  if (i != e.x) {
	    ...
	    if (c > SMALL && c < BIG) {
	      ...
	      bb_constraints_a(e.x, i, 0, BIG, 0.0, status, backup, update);
	...
	for (i = 1; i <= n; i++) {
	  if (i != e.x) {
	    ...
	    if (c > SMALL && c < BIG) {
	      ...
	      bb_constraints_a(e.x, i, 0, SMALL, 0.0, status, backup, update);
	...
	for (i = 1; i <= n; i++) {
	  if (i != e.y) {
	    ...
	    if (c > SMALL && c < BIG) {
	      ...
	      bb_constraints_a(e.y, i, 0, BIG, 0.0, status, backup, update);
...
int bb_constraints_acp_simple(int w, int v, int u, double cost_wv, double cost_wu, bb_status* status, bb_backup* backup, bb_backup* update) {
  ...
  state = bb_constraints_ac(w, v, u, cost_wv, cost_wu, status, backup, update);
  if (state == FAILURE)
    return FAILURE;
  ...
  if ((*status).num_forced_edges.array[w-1] == 2 && (*status).num_forbidden_edges.array[w-1] < n-3) {
	...
	if (c > SMALL && c < BIG) {
	  ...
	  state = bb_constraints_ac(w, i, 0, BIG, 0.0, status, backup, update);
	  if (state == FAILURE)
	    return FAILURE;
	...
	if (c > SMALL && c < BIG) {
	  ...
	  state = bb_constraints_ac(w, i, 0, SMALL, 0.0, status, backup, update);
	  if (state == FAILURE)
	    return FAILURE;
  ...
  if ((*status).num_forced_edges.array[v-1] == 2 && (*status).num_forbidden_edges.array[v-1] < n-3) {
	...
	if (c > SMALL && c < BIG) {
	  ...
	  state = bb_constraints_ac(v, i, 0, BIG, 0.0, status, backup, update);
	  if (state == FAILURE)
	    return FAILURE;
	...
	if (c > SMALL && c < BIG) {
	  ...
	  state = bb_constraints_ac(v, i, 0, SMALL, 0.0, status, backup, update);
	  if (state == FAILURE)
	    return FAILURE;
  ...
  if (u > 0) {
	...
	if (i != u) {
	  ...
	  if (c > SMALL && c < BIG) {
	    ...
	    state = bb_constraints_ac(u, i, 0, BIG, 0.0, status, backup, update);
	    if (state == FAILURE)
	      return FAILURE;
	...
	if (i != u) {
	  ...
	  if (c > SMALL && c < BIG) {
	    ...
	    state = bb_constraints_ac(u, i, 0, SMALL, 0.0, status, backup, update);
	    if (state == FAILURE)
	      return FAILURE;
...
int bb_constraints_acp_recursive(int w, int v, int u, double cost_wv, double cost_wu, bb_status* status, bb_backup* backup, bb_backup* update) {
  ...
  if ((*status).num_forced_edges.array[w-1] == 2 && (*status).num_forbidden_edges.array[w-1] < n-3) {
	...
	if (c > SMALL && c < BIG) {
	  ...
	  state = bb_constraints_acp_recursive(w, i, 0, BIG, 0.0, status, backup, update);
	  if (state == FAILURE)
	    return FAILURE;
	...
	if (c > SMALL && c < BIG) {
	  ...
	  state = bb_constraints_acp_recursive(w, i, 0, SMALL, 0.0, status, backup, update);
	  if (state == FAILURE)
	    return FAILURE;
  ...
  if ((*status).num_forced_edges.array[v-1] == 2 && (*status).num_forbidden_edges.array[v-1] < n-3) {
	...
	if (c > SMALL && c < BIG) {
	  ...
	  state = bb_constraints_acp_recursive(v, i, 0, BIG, 0.0, status, backup, update);
	  if (state == FAILURE)
	    return FAILURE;
	...
	if (c > SMALL && c < BIG) {
	  ...
	  state = bb_constraints_acp_recursive(v, i, 0, SMALL, 0.0, status, backup, update);
	  if (state == FAILURE)
	    return FAILURE;
  ...
  if (u > 0) {
	...
	if (i != u) {
	  ...
	  if (c > SMALL && c < BIG) {
	    ...
	    state = bb_constraints_acp_recursive(u, i, 0, BIG, 0.0, status, backup, update);
	    if (state == FAILURE)
	      return FAILURE;
	...
	if (i != u) {
	  ...
	  if (c > SMALL && c < BIG) {
	    ...
	    state = bb_constraints_acp_recursive(u, i, 0, SMALL, 0.0, status, backup, update);
	    if (state == FAILURE)
	      return FAILURE;
	...
	for (i = 1; i <= n; i++) {
	  if (i != e.x) {
	    ...
	    if (c > SMALL && c < BIG) {
	      ...
	      state = bb_constraints_ac(e.x, i, 0, BIG, 0.0, status, backup, update);
	      if (state == FAILURE)
		return FAILURE;
	      elist_push_last(&modified, e.x, i, BIG);
	...
	for (i = 1; i <= n; i++) {
	  if (i != e.x) {
	    ...
	    if (c > SMALL && c < BIG) {
	      ...
	      state = bb_constraints_ac(e.x, i, 0, SMALL, 0.0, status, backup, update);
	      if (state == FAILURE)
		return FAILURE;
	      elist_push_last(&modified, e.x, i, SMALL);
	...
	for (i = 1; i <= n; i++) {
	  if (i != e.y) {
	    ...
	    if (c > SMALL && c < BIG) {
	      ...
	      state = bb_constraints_ac(e.y, i, 0, BIG, 0.0, status, backup, update);
	      if (state == FAILURE)
		return FAILURE;
	      elist_push_last(&modified, e.y, i, BIG);
	...
	for (i = 1; i <= n; i++) {
	  if (i != e.y) {
	    ...
	    if (c > SMALL && c < BIG) {
	      ...
	      state = bb_constraints_ac(e.y, i, 0, SMALL, 0.0, status, backup, update);
	      if (state == FAILURE)
		return FAILURE;
	      elist_push_last(&modified, e.y, i, SMALL);
...
int bb_constraints_acep_simple(int w, int v, int u, double cost_wv, double cost_wu, bb_status* status, bb_backup* backup, bb_backup* update) {
  ...
  state = bb_constraints_ace(w, v, u, cost_wv, cost_wu, status, backup, update);
  if (state == FAILURE)
    return FAILURE;
  ...
  if ((*status).num_forced_edges.array[w-1] == 2 && (*status).num_forbidden_edges.array[w-1] < n-3) {
	...
	if (c > SMALL && c < BIG) {
	  ...
	  state = bb_constraints_ace(w, i, 0, BIG, 0.0, status, backup, update);
	  if (state == FAILURE)
	    return FAILURE;
	...
	if (c > SMALL && c < BIG) {
	  ...
	  state = bb_constraints_ace(w, i, 0, SMALL, 0.0, status, backup, update);
	  if (state == FAILURE)
	    return FAILURE;
  ...
  if ((*status).num_forced_edges.array[v-1] == 2 && (*status).num_forbidden_edges.array[v-1] < n-3) {
	...
	if (c > SMALL && c < BIG) {
	  ...
	  state = bb_constraints_ace(v, i, 0, BIG, 0.0, status, backup, update);
	  if (state == FAILURE)
	    return FAILURE;
	...
	if (c > SMALL && c < BIG) {
	  ...
	  state = bb_constraints_ace(v, i, 0, SMALL, 0.0, status, backup, update);
	  if (state == FAILURE)
	    return FAILURE;
  ...
  if (u > 0) {
	...
	if (i != u) {
	  ...
	  if (c > SMALL && c < BIG) {
	    ...
	    state = bb_constraints_ace(u, i, 0, BIG, 0.0, status, backup, update);
	    if (state == FAILURE)
	      return FAILURE;
	...
	if (i != u) {
	  ...
	  if (c > SMALL && c < BIG) {
	    ...
	    state = bb_constraints_ace(u, i, 0, SMALL, 0.0, status, backup, update);
	    if (state == FAILURE)
	      return FAILURE;
...
int bb_constraints_acep_recursive(int w, int v, int u, double cost_wv, double cost_wu, bb_status* status, bb_backup* backup, bb_backup* update) {
  ...
  if ((*status).num_forced_edges.array[w-1] == 2 && (*status).num_forbidden_edges.array[w-1] < n-3) {
	...
	if (c > SMALL && c < BIG) {
	  ...
	  state = bb_constraints_acep_recursive(w, i, 0, BIG, 0.0, status, backup, update);
	  if (state == FAILURE)
	    return FAILURE;
	...
	if (c > SMALL && c < BIG) {
	  ...
	  state = bb_constraints_acep_recursive(w, i, 0, SMALL, 0.0, status, backup, update);
	  if (state == FAILURE)
	    return FAILURE;
  ...
  if ((*status).num_forced_edges.array[v-1] == 2 && (*status).num_forbidden_edges.array[v-1] < n-3) {
	...
	if (c > SMALL && c < BIG) {
	  ...
	  state = bb_constraints_acep_recursive(v, i, 0, BIG, 0.0, status, backup, update);
	  if (state == FAILURE)
	    return FAILURE;
	...
	if (c > SMALL && c < BIG) {
	  ...
	  state = bb_constraints_acep_recursive(v, i, 0, SMALL, 0.0, status, backup, update);
	  if (state == FAILURE)
	    return FAILURE;
  ...
  if (u > 0) {
	...
	if (i != u) {
	  ...
	  if (c > SMALL && c < BIG) {
	    ...
	    state = bb_constraints_acep_recursive(u, i, 0, BIG, 0.0, status, backup, update);
	    if (state == FAILURE)
	      return FAILURE;
	...
	if (i != u) {
	  ...
	  if (c > SMALL && c < BIG) {
	    ...
	    state = bb_constraints_acep_recursive(u, i, 0, SMALL, 0.0, status, backup, update);
	    if (state == FAILURE)
	      return FAILURE;
	...
	for (i = 1; i <= n; i++) {
	  if (i != e.x) {
	    ...
	    if (c > SMALL && c < BIG) {
	      ...
	      state = bb_constraints_ace(e.x, i, 0, BIG, 0.0, status, backup, update);
	      if (state == FAILURE)
		return FAILURE;
	      elist_push_last(&modified, e.x, i, BIG);
	...
	for (i = 1; i <= n; i++) {
	  if (i != e.x) {
	    ...
	    if (c > SMALL && c < BIG) {
	      ...
	      state = bb_constraints_ace(e.x, i, 0, SMALL, 0.0, status, backup, update);
	      if (state == FAILURE)
		return FAILURE;
	      elist_push_last(&modified, e.x, i, SMALL);
	...
	for (i = 1; i <= n; i++) {
	  if (i != e.y) {
	    ...
	    if (c > SMALL && c < BIG) {
	      ...
	      state = bb_constraints_ace(e.y, i, 0, BIG, 0.0, status, backup, update);
	      if (state == FAILURE)
		return FAILURE;
	      elist_push_last(&modified, e.y, i, BIG);
	...
	for (i = 1; i <= n; i++) {
	  if (i != e.y) {
	    ...
	    if (c > SMALL && c < BIG) {
	      ...
	      state = bb_constraints_ace(e.y, i, 0, SMALL, 0.0, status, backup, update);
	      if (state == FAILURE)
		return FAILURE;
	      elist_push_last(&modified, e.y, i, SMALL);
