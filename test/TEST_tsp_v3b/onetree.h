...
// un 1-albero sui nodi {1, 2, ..., n} si può vedere come un albero ricoprente sui nodi {1, 2, ..., n} radicato in 1, più un lato aggiuntivo incidente in 1 (oltre a quello appartene; 
